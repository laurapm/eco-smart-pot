...
\section*{Context}
    ...
    will the user control the system through a virtual assistant, but the 
	design and user experience is planned to be exceptional and extremely easy 
	and intuitive.
...
above, the project does not loose sight of the objective. One could say the
