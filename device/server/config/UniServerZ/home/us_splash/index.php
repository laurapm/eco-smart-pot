...
<meta name="Description" content="The Uniform Server ZeroXIV 14.0.0" />
...
<div id="wrap">
  ...
  <table>
   ...
   <td>
    ...
    <ul>
	  ...
	  <li> <b>Apache 2.4.39 VC14 openssl 1.1.1j</b></li>
	...
	<ul>
	  <li> <b>MySQL 8.0.17-community</b></li>
	  <li> MySQL 5.7.27-community</li>	  
      <li> Mariadb 10.4.8</li>
	  <li> Mariadb 5.5.65</li>
	</ul>
	<br />
 ...
 Vista, W7, W8 or W10 Windows OS based computer (UniServer ZeroXIV requires W8+). It is small and quick to download, and can be
