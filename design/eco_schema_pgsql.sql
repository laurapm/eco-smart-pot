...
-- object: public."ALEXA_ORDER" | type: TABLE --
-- DROP TABLE IF EXISTS public."ALEXA_ORDER" CASCADE;
CREATE TABLE public."ALEXA_ORDER"(
	"ID" int8 NOT NULL,
	"ID_TREATMENTS" int8,
	"TOKEN" character varying(100),
	"DATE" timestamp,
	CONSTRAINT "ALEXA_ORDER_pk" PRIMARY KEY ("ID")

);
-- ddl-end --
ALTER TABLE public."ALEXA_ORDER" OWNER TO postgres;
-- ddl-end --

-- object: "TREATMENTS_fk" | type: CONSTRAINT --
-- ALTER TABLE public."ALEXA_ORDER" DROP CONSTRAINT IF EXISTS "TREATMENTS_fk" CASCADE;
ALTER TABLE public."ALEXA_ORDER" ADD CONSTRAINT "TREATMENTS_fk" FOREIGN KEY ("ID_TREATMENTS")
REFERENCES public."TREATMENTS" ("ID") MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
