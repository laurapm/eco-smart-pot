...
CREATE TABLE IF NOT EXISTS `eco`.`TREATMENT_HISTORY` (
  ...
  `TREATMENTS_ID` INT NOT NULL,
  `DATE` TIMESTAMP NULL,
  PRIMARY KEY (`ID`, `ECO_DEVICE_ID`, `TREATMENTS_ID`),
...
CREATE TABLE IF NOT EXISTS `eco`.`PLANT` (
  ...
  `TREATMENT_HISTORY_TREATMENTS_ID` INT NOT NULL,
  PRIMARY KEY (`ID`, `TREATMENT_HISTORY_ID`, `TREATMENT_HISTORY_TREATMENTS_ID`),
  INDEX `fk_PLANT_TREATMENT_HISTORY1_idx` (`TREATMENT_HISTORY_ID` ASC, `TREATMENT_HISTORY_TREATMENTS_ID` ASC) VISIBLE,
  CONSTRAINT `fk_PLANT_TREATMENT_HISTORY1`
    FOREIGN KEY (`TREATMENT_HISTORY_ID` , `TREATMENT_HISTORY_TREATMENTS_ID`)
    REFERENCES `eco`.`TREATMENT_HISTORY` (`ID` , `TREATMENTS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `eco`.`IRRIGATION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eco`.`IRRIGATION` ;

CREATE TABLE IF NOT EXISTS `eco`.`IRRIGATION` (
  `ID` INT NOT NULL,
  `PLANT_ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `eco`.`FERTILIZATION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `eco`.`FERTILIZATION` ;

CREATE TABLE IF NOT EXISTS `eco`.`FERTILIZATION` (
  `ID` INT NOT NULL,
  `PLANT_ID` INT NOT NULL,
  `MAX_TEMP_RANGE` FLOAT NULL,
  `MIN_TEMP_RANGE` FLOAT NULL,
  ...
  PRIMARY KEY (`ID`, `PLANT_ID`),
  INDEX `fk_FERTILIZATION_PLANT1_idx` (`PLANT_ID` ASC) VISIBLE,
  CONSTRAINT `fk_FERTILIZATION_PLANT1`
    FOREIGN KEY (`PLANT_ID`)
    REFERENCES `eco`.`PLANT` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
