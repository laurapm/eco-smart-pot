...
CREATE TABLE IF NOT EXISTS `eco`.`TREATMENT_HISTORY` (
  ...
  `TREATMENTS_ID` INT NOT NULL,
  `DATE` TIMESTAMP NULL,
  PRIMARY KEY (`ID`, `PLANT_ID`, `TREATMENTS_ID`),
...
CREATE TABLE IF NOT EXISTS `eco`.`ECO_DEVICE` (
  ...
  PRIMARY KEY (`ID`, `PLANT_ID`, `PLANT_FAMILY_ID`),
  INDEX `fk_ECO_DEVICE_OWNERS1_idx` (`OWNERS_ID` ASC) VISIBLE,
  INDEX `fk_ECO_DEVICE_PLANT1_idx` (`PLANT_ID` ASC, `PLANT_FAMILY_ID` ASC) VISIBLE,
  CONSTRAINT `fk_ECO_DEVICE_OWNERS1`
    FOREIGN KEY (`OWNERS_ID`)
    REFERENCES `eco`.`OWNERS` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ECO_DEVICE_PLANT1`
    FOREIGN KEY (`PLANT_ID` , `PLANT_FAMILY_ID`)
    REFERENCES `eco`.`PLANT` (`ID` , `FAMILY_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
